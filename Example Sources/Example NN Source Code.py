...
sara = np.array([-15, -6]) # 128 pounds, 63 inches
tom = np.array([15, 6])  # 155 pounds, 68 inches
print("Sara: %.3f" % network.feedforward(sara)) # 0.951 - F
print("Tom: %.3f" % network.feedforward(tom)) # 0.039 - M
